...
class ValidFluent
	...
	private static $error_phone = 'Please enter a valid phone';
...
//
     ...
     * @return ValidFluent
     */
    function phone($errorMsg=NULL)
	{
	if ($this->isValid && (!empty($this->currentObj->value)))
	    {
	    $this->isValid = (preg_match($this->pattern_phone, $this->currentObj->value) > 0) ? TRUE : FALSE;
	    if (!$this->isValid)
		$this->setErrorMsg($errorMsg, self::$error_phone);
	    }
	return $this;
	}
