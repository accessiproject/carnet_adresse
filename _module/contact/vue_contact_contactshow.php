...
<nav role="navigation" aria-label="Menu secondaire">
	<ul>
		<li><a class="btn btn-info" href="<?=hlien("contact","contactindex","id",$contact_id)?>">Retour à la liste des contacts</a></li>
		<li><a class="btn btn-info" href="<?=hlien("contact","contactedit","id",$contact_id)?>">Modifier</a></li>
		<li><a class="btn btn-danger" href="<?=hlien("contact","contactdelete","id",$contact_id)?>">Supprimer</a></li>
	</ul>
</nav>