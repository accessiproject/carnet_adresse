<form method="post" action="<?=hlien("contact","contactedit")?>" enctype="multipart/form-data" novalidate>
	...
	<fieldset>
		...
		<label for="contact_user">Sélectionner l'utilisateur :</label>
		<select id='contact_user' name='contact_user' >
			<?=Entity::HTMLselect("select user_id id, user_email label from user",$contact_user)?>
		</select>
	</fieldset>
